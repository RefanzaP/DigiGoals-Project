...
import 'package:digigoals_app/TabunganBergilir/DetailTabunganBergilir.dart'; // Import halaman DetailTabunganBergilir
...
// Widget Utama Halaman Undang Anggota Bergilir
...
// State Provider untuk Mengelola State Halaman Undang Anggota Bergilir
class UndangAnggotaBergilirStateProvider extends ChangeNotifier {
...
// State Widget untuk UI Halaman Undang Anggota Bergilir
class _UndangAnggotaBergilirState extends State<UndangAnggotaBergilir> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) =>
          UndangAnggotaBergilirStateProvider(), // Provide state provider
      child: Consumer<UndangAnggotaBergilirStateProvider>(
  ...
  // Body Widget Halaman Undang Anggota Bergilir
  Widget _buildBody(
      BuildContext context, UndangAnggotaBergilirStateProvider state) {
    return Padding(
...
// Widget Konfirmasi Undangan Bergilir
